            ...
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className="flex flex-col rounded-lg overflow-hidden h-full w-full max-w-sm shadow-xl">
                <div className="flex flex-col items-center text-center flex-grow relative">
                  ...
                  <Link to={"/"+course.id} target="_top"> <button className="relative inline-flex md:h-12 md:w-42 sm:h-10 sm:wd-40 h-10 w-40  lg:h-16 lg:w-48 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2">
