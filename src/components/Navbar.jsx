  ...
  return (
    ...
    >
      <div className="w-full mx-auto px-4">
        <div className="flex items-center h-24 justify-between md:px-6">
        ...
        <div className="md:hidden h-full bg-gray-900 bg-opacity-70 backdrop-blur-md">
          <div className="px-4 pt-4 pb-6 space-y-4 text-center">
            ...
            <Link 
              ...
              smooth={true}
              duration={500}
              className="text-white text-xl cursor-pointer hover:text-gray-300 bg-violet-900 rounded-2xl p-2 px-7 m-2 hover:scale-105"
              >Join Us</Link>
          </div>
        </div>
      )}
