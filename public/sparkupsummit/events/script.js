...
const backgroundImages = [
  "/sparkupsummit/images/background.png", // Add your image paths
  "/sparkupsummit/images/background2.png",
  "/sparkupsummit/images/background3.png",
  "/sparkupsummit/images/background4.png",
  "/sparkupsummit/images/background5.png",
];
...
function changeBackgroundImage() {
  ...
  setTimeout(() => {
    currentBackgroundIndex =
      (currentBackgroundIndex + 1) % backgroundImages.length; // Loop through images
...
flipImage.addEventListener("mouseenter", () => {
  ...
  setTimeout(() => {
    flipImage.src = "/sparkupsummit/images/img2.jpg"; // Change to the new image
...
flipImage.addEventListener("mouseleave", () => {
  ...
  if (hasFlipped) {
    ...
    setTimeout(() => {
      flipImage.src = "/sparkupsummit/images/img2.jpg"; // Change back to the original image
